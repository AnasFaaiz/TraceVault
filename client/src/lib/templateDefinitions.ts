 ...
 * Frontend version - sync with backend/src/reflections/template-definitions.ts
 */
  ...
  fields: [
    {
      ...
      type: 'textarea',
      placeholder: 'Describe the problem or situation that forced you to make this decision',
      required: true,
    },
    {
      ...
      type: 'textarea',
      placeholder: 'List the paths you could have taken instead. Why didn\'t you pick them?',
      required: true,
    },
    {
      name: 'reasoning',
      ...
      type: 'textarea',
      placeholder: 'Walk through your logic. What convinced you this was the right call?',
      required: true,
    },
    {
      name: 'constraints',
  ...
  fields: [
    {
      ...
      type: 'textarea',
      placeholder: 'Describe the problem. What was happening that shouldn\'t? What error did you see?',
      required: true,
    ...
    },
    {
      ...
      type: 'textarea',
      placeholder: 'Document the approaches you tested. Why didn\'t they work? What new information did each attempt reveal?',
      required: true,
    ...
    },
    {
      ...
      type: 'textarea',
      placeholder: 'The solution. Be specific. Include code snippets, commands, or exact steps if helpful.',
      required: true,
    },
    {
      name: 'root_cause',
  ...
  fields: [
    {
      ...
      type: 'textarea',
      placeholder: 'What got better? Performance? Developer experience? Time to market? Team morale?',
      required: true,
    },
    {
      name: 'gave_up',
      ...
      type: 'textarea',
      placeholder: 'What got worse? What feature or quality did you lose? What technical debt did you accept?',
      required: true,
    },
    {
      name: 'constraints',
      ...
      type: 'text',
      placeholder: 'Why couldn\'t you have it both ways? Budget? Timeline? Business priorities?',
      required: false,
    },
    {
      name: 'revisit_when',
...
export const LESSON_LEARNED: TemplateDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'textarea',
      placeholder: 'I thought [X] would happen. But actually [Y]. This gap taught me...',
      required: true,
    },
    {
      name: 'rule_of_thumb',
      ...
      type: 'text',
      placeholder: 'The one-liner you\'ll remember in 6 months when you face something similar',
      required: true,
    },
    {
      ...
      type: 'text',
      placeholder: 'Are there people who should learn from this? Be specific if useful.',
      required: false,
    },
  ],
};
  ...
  fields: [
    {
      ...
      type: 'textarea',
      placeholder: 'The observable behavior. What did the user see? What error message appeared? Include stack traces if available.',
      required: true,
    ...
    },
    {
      ...
      type: 'textarea',
      placeholder: 'The debugging steps. What did you eliminate? Why were they not the cause?',
      required: true,
    },
    {
      name: 'fix',
      ...
      type: 'textarea',
      placeholder: 'The exact change that made it work. Include code diff or specific line numbers if helpful.',
      required: true,
    },
    {
      name: 'root_cause',
  ...
  fields: [
    {
      ...
      type: 'textarea',
      placeholder: 'Describe the unexpected behavior or limitation you discovered in this library/service.',
      required: true,
    ...
    },
    {
      ...
      type: 'textarea',
      placeholder: 'Did you find it by accident? In production? In tests? Document the pain points.',
      required: true,
    ...
    },
    {
      ...
      type: 'textarea',
      placeholder: 'How do you work around it? Is there a fix? How should you use the library correctly?',
      required: true,
